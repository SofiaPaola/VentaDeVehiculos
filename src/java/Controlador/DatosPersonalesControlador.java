...
public class DatosPersonalesControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DatosPersonalesVO datpVO = new DatosPersonalesVO(datId, usuId, datNombre, 
                datApellido, datTipo, datNumero, datTelefono, datCorreo);
        DatosPersonalesDAO datpDAO = new DatosPersonalesDAO(datpVO);
